...
class Version20221218115654 extends Version
{
    protected $description = "Инфоблок для заявок";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/forms/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/forms/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/forms/list.php?SECTION_ID=#SECTION_ID#',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    'PROPERTY_NAME' => 'Имя',
    'PROPERTY_SURNAME' => 'Фамилия',
    'PROPERTY_COMPANY' => 'Компания',
    'PROPERTY_DEPARTMENT' => 'Отдел',
    'DETAIL_TEXT' => 'Сообщение',
